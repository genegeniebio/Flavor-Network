...
using logistic regresion, SVM, randomforest, MultinomialNB, and plot confusion
matrix
'''
...
if __name__ == '__main__':
    ...
    yum_ingredients = set()
    yum_clean['clean ingredients'].map(
        lambda x: [yum_ingredients.add(i) for i in x])
    ...
    plot_confusion_matrix(
        cm_normalized, yum['cuisine'],
        title='Confusion Matrix based oningredients')
    ...
    plt.figure(figsize=(10, 10))
    plot_confusion_matrix(
        cm_normalized, yum_ingr['cuisine'],
        title='Confusion Matrix based on flavor')
